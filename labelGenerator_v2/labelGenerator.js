...
function changeSize(){
    ...
    quantity.style.fontSize = filteredSize.qtySize + 'rem'
...
function changeBarcode(){
    ...
    barcodePrev.src = 'resources/barcodes-renamed/' +  selectedBarcode.value + '.png'
    barcode.style.maskImage = `url("resources/barcodes-renamed/${selectedBarcode.value}.png")`;
    barcode.style.webkitMaskImage = `url("resources/barcodes-renamed/${selectedBarcode.value}.png")`;
